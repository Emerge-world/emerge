...
COMMUNICATE_MAX_TOKENS = 6
LANGUAGE_PROMPT_SYMBOL_LIMIT = 8
LANGUAGE_RECENT_LEARNED_LIMIT = 6
LANGUAGE_MISUNDERSTAND_DISTANCE_WEIGHT = 0.12
LANGUAGE_MISUNDERSTAND_OVERLAP_WEIGHT = 0.18
